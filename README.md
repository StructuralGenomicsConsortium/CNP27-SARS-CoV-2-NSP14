...
An [SGC]((https://www.thesgc.org/)) Open Chemistry Networks Project (number 27) devoted to improving a hit found against SARS-CoV-2-NSP14. The project is run as part of the READDI-AViDD consortium.
...
For the science background, head to the [wiki](https://github.com/StructuralGenomicsConsortium/CNP27-SARS-CoV-2-NSP14/wiki) or check out the living paper that is being written (here) (need link) (link is also (Need tinyurl link).
